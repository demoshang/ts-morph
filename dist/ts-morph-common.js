...
class InMemoryFileSystemHost {
    constructor(options) {
        ...
        this.getOrCreateDir("/");
        if (!((_a = options) === null || _a === void 0 ? void 0 : _a.skipLoadingLibFiles)) {
...
class InternalDocumentCache {
    ...
    _getKey(filePath, scriptTarget, scriptKind) {
        var _a, _b, _c, _d;
        return (filePath + (_b = (_a = scriptTarget) === null || _a === void 0 ? void 0 : _a.toString(), (_b !== null && _b !== void 0 ? _b : "-1")) + (_d = (_c = scriptKind) === null || _c === void 0 ? void 0 : _c.toString(), (_d !== null && _d !== void 0 ? _d : "-1")));
    }
}
